...
import { getContributions, createContribution, Contribution, CreateContributionData } from '../api/contributions';
      ...
      <div className="mb-4">
        <form onSubmit={handleSubmit} className="p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div>
              <label htmlFor="paymentMethodId" className="block text-sm font-medium text-gray-700 dark:text-gray-200">Payment Method ID</label>
              <input
                type="number"
                id="paymentMethodId"
